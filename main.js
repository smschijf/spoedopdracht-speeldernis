$(document).ready(function(){
  ...
  var $dateField = $('.field-date').find('input');
	var $fieldHiddenDate = $('.field-hidden_date').find('input');

	if($fieldHiddenDate.length) {
    $fieldHiddenDate.hide();
    fillHiddenDate();
  }
